...
public final class Configuration<C> {
    ...
    private Configuration(ConfigurationHelper<C> configHelper) {
        this.configHelper = configHelper;
    }

    public static <C> Configuration<C> create(Path configFolder, String fileName, Class<C> configClass) {
        // SnakeYaml example
        ...
        ConfigurationFactory<C> configFactory = SnakeYamlConfigurationFactory.create(
                ...
                yamlOptions);
        return new Configuration<>(new ConfigurationHelper<>(configFolder, fileName, configFactory));
    }
